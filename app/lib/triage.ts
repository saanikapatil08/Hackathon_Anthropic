...
const SEVERITY_MAP: Record<SymptomKind, TriageResponse["severity"]> = {
  laceration: "moderate",
  orthopedic: "moderate",
  viral: "low",
  mental_health: "low",
...
const SUMMARY_MAP: Record<SymptomKind, string> = {
  laceration: "Possible laceration that may need stitches.",
  orthopedic: "Possible orthopedic injury requiring evaluation.",
  viral: "Mild upper respiratory or viral symptoms.",
  mental_health: "Non-urgent mental health concerns.",
  general: "Non-specific symptoms — rule-based recommendation applied.",
};
...
export function mockTriage(
  ...
  return {
    ...
    generated_by: "mock",
    severity,
    symptom_summary: SUMMARY_MAP[kind],
  };
}
